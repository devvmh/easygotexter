...
package android.widget.custom;

/**
 * Entirely unchanged except instances of "_id" changed to "_order"
 */
...
public abstract class CursorAdapter extends BaseAdapter implements Filterable,
    ...
    protected void init(Context context, Cursor c, boolean autoRequery) {
        ...
        mContext = context;
        mRowIDColumn = cursorPresent ? c.getColumnIndexOrThrow("_order") : -1;
    ...
    public void changeCursor(Cursor cursor) {
        ...
        if (cursor != null) {
            ...
            mRowIDColumn = cursor.getColumnIndexOrThrow("_order");
            mDataValid = true;
